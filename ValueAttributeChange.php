    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="index.php"><span class="glyphicon glyphicon-log-in"></span> Home</a></li>
		...
		<?php
					...
					$operator = "ValueAttributeChange";
					if($operator == "ValueAttributeChange")
					{
						$conn = db ();
						$sql= "TRUNCATE ValueAttributeChange";
							...
							$inputs = $dom->getElementsByTagName('input');
								foreach ($inputs as $input){
										...
										if($typeText=="submit")
										{
										$OriginalCode=$input->getAttribute('value');
										if($OriginalCode!=""){
...
$sql= "INSERT INTO ValueAttributeChange (OriginalCode,mutantV1) VALUES ('".$OriginalCode."','".$RemoveField."')";
$conn = db ();
if ($conn->query($sql) === TRUE) {
					...
					<div class="col-md-4 col-lg-4 col-sm-4">
						<div class="mutationSummary" style="overflow: scroll;height:500px">
							<p>Mutation Summary</p>
							 <?php
 $page_query = "SELECT * FROM ValueAttributeChange";  
...
function mf (data1, data2 ){
			...
			var data3=document.getElementById("PathName").value
			  ...
			  var data4="ValueAttributeChange";
