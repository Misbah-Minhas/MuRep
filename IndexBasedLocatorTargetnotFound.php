    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="index.php"><span class="glyphicon glyphicon-log-in"></span> Home</a></li>
		...
		<?php
					...
					$operator = "IndexBasedLocatorTargetnotFound";
					if($operator == "IndexBasedLocatorTargetnotFound")
					{
						$conn = db ();
						$sql= "TRUNCATE idbaselocator";
							...
							$inputs = $dom->getElementsByTagName('input');
								foreach ($inputs as $input){
										...
										$RemoveField = "";
										addtodb($OriginalCode,$RemoveField);
										}
...
$sql= "INSERT INTO idbaselocator (OriginalCode,mutantV1) VALUES ('".$OriginalCode."','".$RemoveField."')";
$conn = db ();
if ($conn->query($sql) === TRUE) {
