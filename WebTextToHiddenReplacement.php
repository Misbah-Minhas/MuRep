    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="index.php"><span class="glyphicon glyphicon-log-in"></span> Home</a></li>
		...
		<?php
					...
					$operator = "WebTextToHiddenReplacement";
					if($operator == "WebTextToHiddenReplacement")
					{
						$conn = db ();
						$sql= "TRUNCATE webtexttohiddenreplacement";
...
$sql= "INSERT INTO webtexttohiddenreplacement (OriginalCode,mutantV1) VALUES ('".$OriginalCode."','".$RemoveField."')";
$conn = db ();
if ($conn->query($sql) === TRUE) {
					...
					<div class="col-md-4 col-lg-4 col-sm-4">
						<div class="mutationSummary" style="overflow: scroll;height:500px">
							<p>Mutation Summary</p>
							 <?php
 $page_query = "SELECT * FROM webtexttohiddenreplacement";  
...
function mf (data1, data2 ){
			...
			var data3=document.getElementById("PathName").value
			  ...
			  var data4="webtexttohiddenreplacement";
