    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="index.php"><span class="glyphicon glyphicon-log-in"></span> Home</a></li>
		...
		<?php
					...
					$operator = "WebRemoveOptionUnderSelect";
					if($operator == "WebRemoveOptionUnderSelect")
					{
						$conn = db ();
						$sql= "TRUNCATE webremoveoptionunderselect";
							...
							$inputs = $dom->getElementsByTagName('option');
								...
								foreach ($inputs as $input){
										...
										$typeText=$input->getAttribute('value');
...
$sql= "INSERT INTO webremoveoptionunderselect (OriginalCode,mutantV1) VALUES ('".$OriginalCode."','".$RemoveField."')";
$conn = db ();
if ($conn->query($sql) === TRUE) {
					...
					<div class="col-md-4 col-lg-4 col-sm-4">
						<div class="mutationSummary" style="overflow: scroll;height:500px">
							<p>Mutation Summary</p>
							 <?php
 $page_query = "SELECT * FROM webremoveoptionunderselect";  
 ...
 $result = mysqli_query($connect, $page_query);
  ...
  while($row = mysqli_fetch_array($result))  
	...
	///	echo $temp9;
			...
			echo "<h4>Mutants</h4>";
			echo "<span class='ClickMutants'><p onclick=mf(".$row['Sr'].",'mutantV1');><img src='images/bug.jpg' style='width:6%;'/>  Remove Option Under Select Tag</p></span>";
...
function mf (data1, data2 ){
			...
			var data3=document.getElementById("PathName").value
			  ...
			  var data4="webremoveoptionunderselect";
